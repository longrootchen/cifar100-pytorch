...
from models import *
from data import cifar100_train_set, cifar100_test_set
...
class Trainer:
    ...
    def __init__(self, cfgs, model):
        ...
        self.optimizer = SGD(self.model.parameters(), lr=cfgs.lr, momentum=cfgs.momentum,
                             weight_decay=cfgs.weight_decay, nesterov=cfgs.nesterov)
...
if __name__ == '__main__':
    # for training resnext29_16x64d from a checkpoint:
    # $ python -u train.py --work-dir ./experiments/resnext29_16x64d
    #   --resume ./experiments/resnext29_16x64d/checkpoints/last_checkpoint.pth
    ...
    # get data
    train_set = cifar100_train_set(cfgs.data_root)
    valid_set = cifar100_test_set(cfgs.data_root)
